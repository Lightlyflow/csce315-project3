...
def home():
    ...
    :return: render of menuboard page
    """
    ...
    menuItems = {category: [(item[0], item[2]) for item in menuQuery if item[1] == category] for category in
                 menuCategories}
    ...
    return render_template("menuboard.html", menuCategories=menuCategories, numCategories=numCategories,
                           menuItems=menuItems, toppingNames=toppingNames, numCols=numCols, categorySize=categorySize,
                           itemSize=itemSize)
